...
public class Config
{
    ...
    public System.Windows.Point Location { get; set; } = new System.Windows.Point(double.MinValue, double.MinValue);
    public List<LocationPerMachine> LocationList { get; set; } = [];
